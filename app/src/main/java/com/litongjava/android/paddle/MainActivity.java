package com.litongjava.android.paddle;
...
public class MainActivity extends AppCompatActivity {
  ...
  static {
    //System.loadLibrary("litongjava-paddle-ocr-native");
    ...
    if (requestAllPermissions()) {
      ...
      if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
        ...
        if (photoFile != null) {
          ...
          String appFileprovider = "com.litongjava.androidpaddleocr.fileprovider";
